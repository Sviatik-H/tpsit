...
class Battleship {
  ...
  */
  ...
  bool addShip(int direction, int dimension, int row, int column) {
    ...
    switch (direction) {
      case 1:
        ship = Ship.nord(dimension, column, row, side);
        break;
      case 2:
        ship = Ship.east(dimension, column, row, side);
        break;
      case 3:
        ship = Ship.south(dimension, column, row, side);
        break;
      case 4:
        ship = Ship.west(dimension, column, row, side);
        break;
      default:
        return false;
    }
